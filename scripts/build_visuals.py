...
def build_hero() -> Image.Image:
    ...
    rounded_label(draw, (86, 54), "PROJECT PUBLICATION", "#263650", AMBER)
    draw.text((84, 126), "Project", font=font(76, True), fill=WHITE)
    draw.text((84, 208), "Publisher", font=font(70, True), fill=WHITE)
    draw.text((90, 315), "Make the project clear in public.", font=font(31, True), fill="#D9E3F0")
    draw.text((90, 360), "Keep the story true as it changes.", font=font(28), fill="#D9E3F0")
    ...
    draw.text((448, 458), "DISTRIBUTE", font=font(19, True), fill=AMBER)
    draw.text((594, 458), "UPDATE", font=font(19, True), fill=MINT)
    draw.text((90, 535), "First pass is read-only. You approve edits and public actions.", font=font(22), fill=SLATE)
